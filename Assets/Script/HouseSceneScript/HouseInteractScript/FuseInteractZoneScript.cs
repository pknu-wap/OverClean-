...
public class FuseInteractZoneScript : MonoBehaviour
{
    ...
    public GameObject FuseInteractZonePlayerCounter1;
    public GameObject FuseInteractZonePlayerCounter2;
    ...
    void UpdatePlayerCounter()
    {
        ...
        {
            FuseInteractZonePlayerCounter1.GetComponent<SpriteRenderer>().color = new Color(0.152f, 0.075f, 0.329f);
            FuseInteractZonePlayerCounter2.GetComponent<SpriteRenderer>().color = new Color(0.152f, 0.075f, 0.329f);
        }
        else if (zonePlayerCounter == 1)
        {
            FuseInteractZonePlayerCounter1.GetComponent<SpriteRenderer>().color = Color.white;
            FuseInteractZonePlayerCounter2.GetComponent<SpriteRenderer>().color = new Color(0.152f, 0.075f, 0.329f);
        }
        else if (zonePlayerCounter == 2)
        {
            FuseInteractZonePlayerCounter1.GetComponent<SpriteRenderer>().color = Color.white;
            FuseInteractZonePlayerCounter2.GetComponent<SpriteRenderer>().color = Color.white;
        }
    }
}
