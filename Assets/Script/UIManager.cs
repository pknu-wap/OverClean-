...
public class UIManager : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if(!UIManager.instance.tutorialPanelOpen && pause)
        {
            if (Input.GetKeyDown(KeyCode.Escape))
            {
                pause = true;
        ...
        else if(!UIManager.instance.tutorialPanelOpen && pause && Input.GetKeyDown(KeyCode.Escape))
        {
            ClosePausePanel();
        }
